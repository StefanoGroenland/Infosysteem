                    ...
                    <div class="widget-content clearfix">
                        <main>
                            <ol class="breadcrumb">
                                ...
                                <li><a href="./?control=stage&action=klantToevoegen">Klant toevoegen</a></li>
                            </ol>
                            <!--ZOEK FUNCTIE-->
                            <form action="." method="post" class="pure-form" style="float:right;">
                                ...
                                <input type="text" class="pure-input-rounded" style="width: 120px;" name="waarde">
                                ...
                                <tbody>
                                    <?php foreach ($klanten as $klant): ?>
                                        <tr class="klikbaar">
                                            ...
                                            <td>
                                                <a href="./?control=stage&action=klant&klant_id=<?php echo $klant->geefId(); ?>"></a>
