            ...
            <div class="widget-container fluid-height">
                <div class="widget-content padded clearfix">
                    <div class="widget-content clearfix">
                        ...
                        <form action="." method="post" class="pure-form pure-form-aligned big">
                            ...
                            <fieldset >
                                ...
                                <div class="pure-control-group">
                                    ...
                                    <input type="text" name="huisnummer" placeholder="vul in" maxlength="6">
                                </div>
                                ...
                                <div class="pure-control-group">
                                    ...
                                    <input type="email" name="email" placeholder="vul in" >
                                </div>

                                <div class="pure-control-group">
                                    <label>Telefoon</label>
                                    <input type="text" name="telefoon" placeholder="vul in" maxlength="11">
                                </div>

                                <div class="pure-control-group">
                                    <label>Mobiel</label>
                                    <input type="text" name="mobiel" placeholder="vul in" maxlength="10">
                                </div>
