<header>
                    ...
                    <div class="pull-right">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="./?control=klant&action=wijzigMijnGegevens&gebruiker_id=<?php echo $_SESSION['gebruiker']->geefId(); ?> ">
                                            <i class="fa fa-user"></i>My Account</a>
                                    </li>
                                    <li><a href="./?control=klant&action=wijzigMijnGegevens&gebruiker_id=<?php echo $_SESSION['gebruiker']->geefId(); ?>">
                                            <i class="fa fa-gear"></i>Account Settings</a>
                                    </li>
                                    <li><a href="./?control=klant&action=uitloggen">
    ...
    <div class="container-fluid main-nav clearfix">
                    <div class="nav-collapse">
                        <ul class="nav">
                            <li>
                                <a href="./?control=klant&action=default"><span aria-hidden="true" class="se7en-home"></span>Dashboard</a>
                            </li>
                            <li>
                                <a href="./?control=klant&action=tickets">
                                    <span aria-hidden="true" class="se7en-feed"></span>Tickets
                                </a>
                            </li>
                            
                            <li>
                                <a href="./?control=klant&action=rapporten">
                            ...
                            <li>
                                <a href="./?control=klant&action=escalaties">
