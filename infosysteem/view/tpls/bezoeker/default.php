  ...
  <body class="login1">
    ...
    <div class="login-wrapper">
      <div class="login-container">
        <a href="./"><img width="200" height="60" src="images/logo-login@2x.png" /></a>
        ...
        <form action="." method="post" class="pure-form pure-form-aligned">
          ...
          <div class="form-group">
            ...
            <input class="form-control" placeholder="Gebruikersnaam" autofocus type="text" name="gn" required="required">
              
          </div>
            
          <div class="form-group">
              
            <input class="form-control" placeholder="Wachtwoord" type="password" name="ww" required="required"><input type="submit" value="&#xf054;">
          ...
          <div class="form-options clearfix">
            ...
            <div class="text-left">
              ...
              <label class="checkbox"><input type="checkbox"><span>Onthoud mij</span></label>
