    ...
    var L = function (h) {
        ...
        j.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0,
            ...
            fnRowCallback: null, fnServerData: function (e, j, m, k) {
                ...
                oPaginate: {sFirst: "Eerste", sLast: "Laatste", sNext: "Volgende", sPrevious: "Vorige"}, sEmptyTable: "Geen resultaten gevonden", sInfo: "Showing _END_ van de _TOTAL_ logs", sInfoEmpty: "Showing 0 van de 0 logs", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Show _MENU_ logs", sLoadingRecords: "Loading...", sProcessing: "Verwerken...", sSearch: "Zoek Log:", sUrl: "", sZeroRecords: "Geen overeenkomsten gevonden"}, oSearch: h.extend({}, j.models.oSearch), sAjaxDataProp: "aaData",
        ...
        h.fn.dataTableLogs = j;
        h.fn.dataTableLogs = j;
        h.fn.dataTableLogsSettings = j.settings;
        h.fn.dataTableLogsExt = j.ext
    };
    "function" === typeof define && define.amd ? define(["jquery"], L) : jQuery && !jQuery.fn.dataTableLogs &&
            L(jQuery)
})(window, document);
